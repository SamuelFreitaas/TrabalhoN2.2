...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1054, 476));
        setMinimumSize(new java.awt.Dimension(1054, 476));
        setName("FramePrincipal"); // NOI18N
        setSize(new java.awt.Dimension(1054, 476));
    ...
    private void cadastroLivroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastroLivroActionPerformed
       JInternalFrame tLivro = new TelaCadastroLivro();
       painelDesktop.removeAll();
       painelDesktop.add(tLivro);
